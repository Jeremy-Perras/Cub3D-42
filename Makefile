...
#    Updated: 2022/05/03 09:21:54 by jperras          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = cub3D

SRCS = test.c windows.c hook.c raycasting.c parse.c parse_texture.c utils.c check_map.c floor_ceiling_color.c raycasting2.c put_colors.c \
				image2.c teste2.c
INCLUDES = -I./includes
